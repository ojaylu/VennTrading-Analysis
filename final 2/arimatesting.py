...
def arimatesting1(history, test, plotderivationgraph):
...
def arimatestingall(history, test, plotderivationgraph):
...
def myarima(data, clf, pred_num, ARIMAstrategy, plotderivationgraph, plotbfsgraph):
    ...
    arimatesting1(history_c, test_c, plotderivationgraph)
    # arimatesting1(history_h, test_h, plotderivationgraph)
    # arimatesting1(history_l, test_l, plotderivationgraph)
    # arimatesting1(history_v, test_v, plotderivationgraph)
        
    arimatestingall(history_c, test_c, plotderivationgraph)
    # arimatestingall(history_h, test_h, plotderivationgraph)
    # arimatestingall(history_l, test_l, plotderivationgraph)
    # arimatestingall(history_v, test_v, plotderivationgraph)
    ...
    if ARIMAstrategy == 'predict one in a time':
        ...
        x_future_2 = x_future
        x_future_2, combineflag, macdlb, macdub, rsilb, rsiub, newsurplus = bruteforce(x_future_2,plotmacdgraph=False,
                                                                                       plotrsigraph=False,
                                                                                       plotobvgraph=False,
                                                                                       plotemagraph=False)
        print("here is the strategies suggested by bruteforce: \n MACD:", macdlb, macdub, '\n, RSI:', rsilb, rsiub)
